...
<body>
	...
	<div class="container">
		...
		<a class="brand">
		<img src="admin/images/bou.png" width="60" height="60">
 	</a>
	<a class="brand">
	 <h2>Bangladesh Open University Voting System</h2>
	 <div class="chmsc_nav"><font size="4" color="white">B.Sc In CSE</font></div>
 	</a>
...
<option class="option1">--Select Candidate "FEMALE"--</option>
...
<option class="option1">--Select Candidate "MALE"--</option>
<?php
$representative=mysqli_query($conn,"select * from candidate where Position='3rd Year Representative'")or die(mysqli_error());
while($row=mysqli_fetch_array($representative)){ $representative_id=$row['CandidateID']; ?>
<option value="<?php echo $representative_id; ?>" class="option1"><?php  echo $row['FirstName']." ".$row['LastName']; ?></option>
